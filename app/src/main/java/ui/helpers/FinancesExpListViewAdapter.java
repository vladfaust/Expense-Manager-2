...
public class FinancesExpListViewAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        TextView childDate = (TextView) convertView.findViewById(R.id.finances_childDate);
        TextView  childPrice = (TextView) convertView.findViewById(R.id.finances_childPrice);
